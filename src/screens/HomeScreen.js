  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Pressable onPress={() => navigation.navigate("BasicRule")}>
        <Image
          resizeMode="stretch"
          source={require("../img/RuleBasic.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyTyranid")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyTyrand.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyAdepta")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyAdepta.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyCustodes")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyCustodes.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyMechanicus")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyMechanicus.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyAeldari")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyAeldari.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyBlacktemplars")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyBlacktemplars.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyWorldEaters")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyWorldEaters.png")}
          style={styles.image}
        />
      </Pressable>
      ...
      <Pressable onPress={() => navigation.navigate("ArmyThousandSons")}>
        <Image
          resizeMode="stretch"
          source={require("../img/ArmyThousandSons.png")}
          style={styles.image}
        />
      </Pressable>
    </ScrollView>
